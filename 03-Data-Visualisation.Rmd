...
```{r geom-setting-color, echo=F, eval=T, out.width="100%", fig.align="center", fig.cap="Predefined colour namecode"}
...
<!-- 關於圖表中插入文字，應利用`geom_text()`函式，請先參考[此](#標註文字與標籤)。以加入各品種（Species）分群中心點的名稱為例，以下程式碼先行透過`group_by() %>% summarise()`計算各分群的中心點位置，最後再添上文字。 -->
